...
import type { RecipeProductSeeder } from '../seeders/recipeProduct.js';

export class CustomResourceManager {
	private readonly customResources: { [key: string]: CustomResource };

	public constructor(private readonly logger: BaseLogger, usepaProductSeeder: UsepaProductSeeder, generalProductSeeder: GeneralProductSeeder, redshiftProductSeeder: RedshiftProductSeeder, recipeProductSeeder: RecipeProductSeeder) {
		this.customResources = {
			...
			'Custom::RecipeProductSeeder': recipeProductSeeder
		};
	}
