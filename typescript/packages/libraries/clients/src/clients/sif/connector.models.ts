...
export interface ConnectorOutputIntegrationRequestEvent {
	...
	connector: {
		name: string,
		/**
		 * This will be parameters that will be specific to each output connector
		 * e.g. For DataZone Connector, this will be the domain and project id to publish the asset to
		 */
		parameters: Record<string, any>;
	};
}
