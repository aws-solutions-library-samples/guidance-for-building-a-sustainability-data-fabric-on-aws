...
export class Scope3Category4UpstreamTransportationandDistributionandCategory9DownstreamTransportationandDistribution extends BaseUSEPA {
	...
	private async saveAsCsv(): Promise<string> {
		...
		// output as csv
		const csvPath = path.resolve(__dirname, '..', '..', 'generatedResources', this.outputPrefix, 'scope-3-category-4-upstream-transportation-and-distribution-and-category-9-downstream-transportation-and-distribution.csv');
