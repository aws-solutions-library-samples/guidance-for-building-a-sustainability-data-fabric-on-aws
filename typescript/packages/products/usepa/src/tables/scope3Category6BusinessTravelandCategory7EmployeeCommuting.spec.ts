...
import { Scope3Category6BusinessTravelandCategory7EmployeeCommuting } from './scope3Category6BusinessTravelandCategory7EmployeeCommuting.js';

describe('Scope3Category6BusinessTravelandCategory7EmployeeCommuting', () => {
    let underTest:Scope3Category6BusinessTravelandCategory7EmployeeCommuting;
