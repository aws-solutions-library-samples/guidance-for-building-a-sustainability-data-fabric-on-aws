...
const registerContainer = (app: FastifyInstance) => {
	...
	diContainer.register({
		...
		triggerPipelineService: asFunction((container: Cradle) => new TriggerPipelineService(app.log, container.s3Client, bucketName, container.pipelineClient, securityContext, container.executionClient, container.dataZoneClientFactory, domainId!, athenaEnvironmentId!, roleArn!, projectId!), {
			...commonInjectionOptions
		}),
