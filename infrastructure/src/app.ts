...
const sdfAdminUserId = getOrThrow(app, 'sdfAdminUserId');
...
const commonInfrastructureStack = new CommonInfrastructureStack(app, 'SdfSpokeCommonStack', {
	...
	description: 'Infrastructure shared between SDF and SDF demo -- Guidance for Sustainability Data Fabric on AWS (SO9430)',
...
demos.addDependency(commonInfrastructureStack);
...
commonHubInfrastructureStack.addDependency(demos);
commonHubInfrastructureStack.addDependency(products);
