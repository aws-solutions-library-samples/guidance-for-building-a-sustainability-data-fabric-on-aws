...
import { MustacheParamBaseType, SQLDef, SQLViewDef } from '../models.js';
...
export function getSqlContents(sqlDef: SQLDef | SQLViewDef, mustacheParam: MustacheParamBaseType, path: string = '/opt'): string[] {
	return getSqlContent(sqlDef, mustacheParam, path)
		.split(';')
