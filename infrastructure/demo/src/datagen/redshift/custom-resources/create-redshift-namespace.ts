...
import { getRedshiftServerlessNamespace } from './redshift-serverless.js';
import { aws_sdk_client_common_config } from './sdk-client-config.js';
import { getFunctionTags } from './tags.js';
	...
	return new RedshiftServerlessClient({
		...
		credentials: fromTemporaryCredentials({
			...
			params: {
				...
				RoleSessionName: 'redshift-serverless-api-in-sdf-demo',
...
async function waitForRedshiftServerlessNamespaceStatus(client: RedshiftServerlessClient, namespaceName: string): Promise<Namespace | undefined> {
